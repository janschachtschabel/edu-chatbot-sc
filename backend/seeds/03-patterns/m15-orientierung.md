...
sources:
  - rag
rag_areas:
  # F1 (2026-08-10): Plattformwissen allein trägt nur 10 Bruchstücke, während
  # WirLernenOnline (93) die Plattform beschreibt und FAQ (30) genau die
  # Einsteigerfragen enthält, die M15 beantwortet. Bewusst NICHT die
  # Organisations-/Projekt-Korpora: M15 ist der kurze Erstkontakt, kein
  # Auskunftsschalter über Vereine und Schlussberichte.
  - Plattformwissen
  - WirLernenOnline
  - FAQ
core_rule: |
